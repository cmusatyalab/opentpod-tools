...
def main():
	...
	parser.add_argument("-l", "--level", required=True, type=int, help="1(continuous checking) 2(random checking) 3(complete checking)")
	...
	parser.add_argument("-t", "--threshold", type=int, default=DIFF_THRESHOLD, help="Threshold of difference")
	parser.add_argument("-r", "--ratio", type=float, default=DEFAULT_RATIO, help="Random ratio")
	...
	p = Project.generate(args.output, {'project_name': args.output,})
	p.make_dataset().save()
